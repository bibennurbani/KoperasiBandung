<div>
	...
	&nbsp;&nbsp;<small><span id="realDate">DD-MM-YYYY</span>, <span id="hours">00</span>:<span id="min">00</span>:<span id="sec">00</span></small>
	&nbsp;&nbsp;</h4>
</div>
<br>
<div class="row">
		...
		<div class="portlet">
			...
			<div class="portlet-content panel-thread scrollable-panel">
				<ul class="panel-lists">
					<?php for ($i=0; $i < 10; $i++) { ?>
					<li>
						<img src="<?php echo base_url('assets/img/avatars/avatar-1-md.png'); ?>" alt="Avatar" class="panel-list-avatar">
