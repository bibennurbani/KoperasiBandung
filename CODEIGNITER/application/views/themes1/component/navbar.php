				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu noticebar-menu" role="menu">
						...
						<li>
							<a href="#" class="noticebar-item">
								<span class="noticebar-item-image">
									<img src="<?php echo base_url('assets/img/avatars/avatar-1-xs.png'); ?>" style="width: 50px" alt="">
								</span>
								<span class="noticebar-item-body">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown navbar-profile">
					<a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;">
						<img src="<?php echo base_url('assets/img/avatars/avatar-1-xs.png'); ?>" class="navbar-profile-avatar" alt="">
